...
from Logged_In_As_Username_Page.Logout_Button import handle_logout_account_btn_click
from After_Logout_Page.Page_After_Logout import handle_page_after_logout


def complete_test_case_4():
    ...
    try:
        ...
        # task 9 is done here
        handle_logout_account_btn_click()
        # task 10 is done here
        handle_page_after_logout(url)
        time.sleep(2)
